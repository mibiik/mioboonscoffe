...
const menuItems = {
  ...
  'drinks': [ 
    ...
    { name: 'Büyük Su', description: '', price: 110, image: drinkImage },
    { name: 'Su', description: '330 ml damla su', price: 90, image: drinkImage },
    ...
    { name: 'Çay', description: '', price: 60, image: drinkImage },
  ],
  'cocktails': [
  ...
  'coffee': [
    ...
    { name: 'Latte', description: 'Sıcak servis edilen latte', price: 175, image: drinkImage },
